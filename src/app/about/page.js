  ...
  return (
    <>
      <main>
        {/*  Header */}
        <header>
          <section className="pt-24 pb-28 w-4/5 md:w-3/5 mx-auto">
          ...
          <section className="flex flex-col justify-center items-center px-16 border-black border-y-2px md:border-y-3px bg-yellow py-32">
        ...
        <section>
          <div className="py-16 md:py-24 w-4/5 md:w-3/6 mx-auto">
            <h2 className="font-sans font-black text-3xl mb-4">Open-source at Core</h2>
            <p className="font-serif font-normal text-xl mb-5">
        ...
        <section id="contact" className="bg-brown border-black border-b-2px md:border-b-3px">
          <div className="py-16 md:py-24 w-4/5 md:w-3/6 mx-auto">
